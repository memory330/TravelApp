...
public class SplashView extends View {
    ...
    public SplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(context.getResources().getColor(R.color.splash_backgroud));
        ...
        mTowerPath = new SvgPathParser().parsePath(context.getResources().getString(R.string.splash_view));
    ...
    private ValueAnimator getAlphaAnimator() {
        ...
        va.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mListener != null) {
                    mListener.onEnd(SplashView.this);
                }
            }
    ...
    public interface OnEndListener {
        void onEnd(SplashView wowSplashView);
    }
